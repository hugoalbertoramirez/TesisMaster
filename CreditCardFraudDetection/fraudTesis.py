...
def plot_hist():
    ...
    index_no_fraud = np.random.choice(data[data['Class'] == 0].index, fraud)
    ...
    ax = sns.countplot(y="Class", color='c', data=data)
...
for n in n_clusters:
    ...
    p_train = find_metrics(X_train, y_train, alphas, y, b, gaussians)
